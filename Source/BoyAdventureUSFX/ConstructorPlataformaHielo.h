...
#include "ConstructorPlataformaHielo.generated.h"

UCLASS()
class BOYADVENTUREUSFX_API AConstructorPlataformaHielo : public AActor, public IConstructorPlataforma
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AConstructorPlataformaHielo();
...
private:
	...
	APlataformaHielo* PlataformaConstruida;
