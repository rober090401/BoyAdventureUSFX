...
#include "ConstructorPlataformaTrampa.generated.h"

UCLASS()
class BOYADVENTUREUSFX_API AConstructorPlataformaTrampa : public AActor, public IConstructorPlataforma
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AConstructorPlataformaTrampa();
...
private:
	APlataformaTrampa* PlataformaConstruida;
protected:
